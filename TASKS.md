...
**Status:** Complete — v0.1.0 released. Merged to `master`.
...
| 5.7 | Tag v0.1.0 and create GitHub Release | Developer | ✅ | Git tag `v0.1.0`, https://github.com/SuceaCosmin/sbom-validator/releases/tag/v0.1.0 |
